...
```
- 允许更新次版本号和修订号
- `^3.2.0` 可以安装 `3.2.0` 到 `3.x.x`（但不包括 `4.0.0`）
- **npm install 默认使用 `^`**
...
```
- 只允许更新修订号
- `~1.2.0` 可以安装 `1.2.0` 到 `1.2.x`（但不包括 `1.3.0`）
- 适合对稳定性要求高的场景
...
- [Semantic Versioning 官方文档](https://semver.org/lang/zh-CN/)
- [npm 版本号文档](https://docs.npmjs.com/cli/v9/configuring-npm/package-json#dependencies)
- [npm version 命令](https://docs.npmjs.com/cli/v9/commands/npm-version)
